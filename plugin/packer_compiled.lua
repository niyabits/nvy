...
_G.packer_plugins = {
  ...
  ["vscode.nvim"] = {
    loaded = true,
    path = "/home/yashguptaz/.local/share/nvim/site/pack/packer/start/vscode.nvim",
...
try_loadstring("\27LJ\2\n9\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\16refactoring\frequire\0", "config", "nvim-treesitter-refactor")
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-bufferline.lua', 'nvim-toggleterm.lua', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
