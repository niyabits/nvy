...
function M.common_on_attach(_, bufnr)
	...
	bufnnoremap("<leader>e", "<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>")
	bufnnoremap("[d", "<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>")
	bufnnoremap("]d", "<cmd>lua vim.lsp.diagnostic.goto_next()<CR>")
